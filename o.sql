...
-- Dumping data for table uzorsym28.tdk_soba: ~1 rows (approximately)
...
-- Dumping data for table uzorsym28.tdk_task: ~3 rows (approximately)
/*!40000 ALTER TABLE `tdk_task` DISABLE KEYS */;
INSERT INTO `tdk_task` (`id`, `task`, `dueDate`) VALUES
	(1, 'pravi', '2013-01-01 00:04:00'),
	(2, 'jos jedan', '2018-01-01 00:00:00'),
	(3, 'jos jedan', '2018-01-01 00:00:00');
